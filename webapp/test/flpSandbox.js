		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Parceiros em UI5",
									"targetURL": "#z00parceiros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z00parceiros-display": {
								"semanticObject": "z00parceiros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z00.parceiros",
									"url": sap.ui.require.toUrl("z00/parceiros")
								}
							}
						}
					}
